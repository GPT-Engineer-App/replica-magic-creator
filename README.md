...
**Project**: replica-magic-creator 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: make an exact replica fo this website  
...
```sh
git clone https://github.com/GPT-Engineer-App/replica-magic-creator.git
cd replica-magic-creator
npm i
